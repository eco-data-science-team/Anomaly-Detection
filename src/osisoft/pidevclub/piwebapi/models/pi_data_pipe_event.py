...
class PIDataPipeEvent(object):
	...
	def __init__(self, action=None, timestamp=None, units_abbreviation=None, good=None, questionable=None, substituted=None, annotated=None, value=None, errors=None, web_exception=None):
	...
	def __eq__(self, other):
		if not isinstance(other, PIDataPipeEvent):
			return False
