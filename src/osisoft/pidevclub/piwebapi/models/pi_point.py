...
class PIPoint(object):
    ...
    def __init__(self, web_id=None, id=None, name=None, path=None, point_source=None, descriptor=None, point_class=None, point_type=None, digital_set_name=None, span=None, zero=None, engineering_units=None, step=None, future=None, display_digits=None, links=None, web_exception=None):
...
#    @point_source.setter
    def point_source(self, point_source):
