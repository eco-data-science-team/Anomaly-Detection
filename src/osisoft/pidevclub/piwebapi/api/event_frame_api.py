...
class EventFrameApi(object):
	...
	def delete_annotation_attachment_media_by_id(self, id, web_id, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.delete_annotation_attachment_media_by_id_with_http_info(id, web_id, **kwargs)
		else:
			(data) = self.delete_annotation_attachment_media_by_id_with_http_info(id, web_id, **kwargs)
			return data

	def delete_annotation_attachment_media_by_id_with_http_info(self, id, web_id, **kwargs):
		all_params = ['id', 'web_id']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method delete_annotation_attachment_media_by_id_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('id' not in params) or (params['id'] is None):
			raise ValueError("Missing the required parameter `id` when calling `delete_annotation_attachment_media_by_id_with_http_info`")
		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `delete_annotation_attachment_media_by_id_with_http_info`")
		...
		return self.api_client.call_api('/eventframes/{webId}/annotations/{id}/attachment/media', 'DELETE',
				path_params,
				query_params,
				header_params,
				body =body_params,
	...
	def get_annotation_attachment_media_metadata_by_id(self, id, web_id, selected_fields=None, web_id_type=None, **kwargs):
		kwargs['_return_http_data_only'] = True
		if kwargs.get('callback'):
			return self.get_annotation_attachment_media_metadata_by_id_with_http_info(id, web_id, selected_fields, web_id_type, **kwargs)
		else:
			(data) = self.get_annotation_attachment_media_metadata_by_id_with_http_info(id, web_id, selected_fields, web_id_type, **kwargs)
			return data

	def get_annotation_attachment_media_metadata_by_id_with_http_info(self, id, web_id, selected_fields=None, web_id_type=None, **kwargs):
		all_params = ['id', 'web_id', 'selected_fields', 'web_id_type']
		all_params.append('callback')
		all_params.append('_return_http_data_only')
		all_params.append('_preload_content')
		...
		for key, val in iteritems(params['kwargs']):
			if key not in all_params:
				raise TypeError(
					"Got an unexpected keyword argument '%s'"
					" to method get_annotation_attachment_media_metadata_by_id_with_http_info" % key
				)
			params[key] = val
		del params['kwargs']

		if ('id' not in params) or (params['id'] is None):
			raise ValueError("Missing the required parameter `id` when calling `get_annotation_attachment_media_metadata_by_id_with_http_info`")
		if ('web_id' not in params) or (params['web_id'] is None):
			raise ValueError("Missing the required parameter `web_id` when calling `get_annotation_attachment_media_metadata_by_id_with_http_info`")
		...
		return self.api_client.call_api('/eventframes/{webId}/annotations/{id}/attachment/media/metadata', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
