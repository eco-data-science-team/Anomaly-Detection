...
class NotificationContactTemplateApi(object):
	...
	def get_with_http_info(self, web_id, selected_fields=None, web_id_type=None, **kwargs):
		...
		return self.api_client.call_api('/notificationcontacttemplates/{webId}', 'GET',
				path_params,
				query_params,
				header_params,
				body =body_params,
				...
				response_type ='PINotificationContactTemplate',
